...
export default function () {
    return function EARL(input, rules, outcomes) {
        ...
        return Future.from(jsonld.compact(earl, ACTContext)).map((compact) => stringify(compact, null, 2));
    };
}
/** @internal */
export const assertor = {
    "@context": {
    ...
    "doap:description": "Suite of open and standards-based tools for performing reliable accessibility conformance testing at scale",
    "doap:repository": {
