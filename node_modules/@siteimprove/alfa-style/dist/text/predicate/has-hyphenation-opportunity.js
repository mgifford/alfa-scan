 ...
 * @public
 */
export function hasHyphenationOpportunity(device, context) {
    return (text) => text
        .parent()
        ...
        .every((parent) => {
        switch (Style.from(parent, device, context).computed("hyphens").value.value) {
            case "none":
                return false;
            case "manual":
...
//# sourceMappingURL=has-hyphenation-opportunity.js.map