...
import { isBlockContainer, isFlexContainer, isGridContainer, } from "../predicate/index.js";
const { or } = Predicate;
const base = Longhand.fromKeywords({ inherits: false, use: (value) => value.map(Option.of) }, "visible", "hidden", "clip", "scroll", "auto");
...
export default Longhand.extend(base, {
    ...
    use: (value, style) => value.map((overflow) => Option.conditional(overflow, () => isContainer(style))),
});
