...
export default Rule.Atomic.of({
    ...
    evaluate({ document }) {
        return {
            ...
            expectations(target) {
                return {
                    1: Question.of("is-title-descriptive", target).map((descriptive) => expectation(descriptive, () => Outcomes.TitleIsDescriptive, () => Outcomes.TitleIsNotDescriptive)),
                };
            },
        };
    },
...
export var Outcomes;
(function (Outcomes) {
    Outcomes.TitleIsDescriptive = Ok.of(Diagnostic.of("This `<title>` describes the content of the page"));
    Outcomes.TitleIsNotDescriptive = Err.of(Diagnostic.of("This `<title>` does not describe the content of the page"));
})(Outcomes || (Outcomes = {}));
