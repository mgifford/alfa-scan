...
const { hasExplicitRole, hasNonEmptyAccessibleName, isIncludedInTheAccessibilityTree, } = DOM;
        ...
        return {
            applicability() {
                return getElementDescendants(document, Node.fullTree)
                    ...
                    .filter(and(isIncludedInTheAccessibilityTree(device), (summary) => summary.isSummaryForItsParentDetails(), 
            ...
            expectations(target) {
                return {
                    ...
                    hasNonEmptyAccessibleName(device)(target), () => Outcomes.HasAccessibleName, () => Outcomes.HasNoAccessibleName),
                };
            },
        };
    },
...
export var Outcomes;
(function (Outcomes) {
    Outcomes.HasAccessibleName = Ok.of(Diagnostic.of(`The \`<summary>\` element has an accessible name`));
    Outcomes.HasNoAccessibleName = Err.of(Diagnostic.of(`The \`<summary>\` element does not have an accessible name`));
})(Outcomes || (Outcomes = {}));
