    ...
    Simple.parse = (parseSelector) => {
        return (input) => {
            ...
            if (Token.isColon(first)) {
                ...
                return either(PseudoElement.parseWithoutColon(parseSelector, isDoubleColon), PseudoClass.parseWithoutColon(parseSelector))(input);
            }
            return either(Type.parse, Universal.parse)(input);
        };
    };
})(Simple || (Simple = {}));
