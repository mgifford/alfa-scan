...
(function (PseudoElement) {
    ...
    const functionalParsers = (parseSelector) => {
        return {
     ...
     */
    function parseWithoutColon(parseSelector, isDoubleColon) {
        return (input) => {
            if (input.isEmpty()) {
    ...
    PseudoElement.parseWithoutColon = parseWithoutColon;
